...
public class BookController {
	...
	private static final List<Book> books = new ArrayList<>(
			Arrays.asList(new Book(1L, "The Great Gatsby", "F. Scott Fitzgerald", "1925-04-10"),
					new Book(2L, "To Kill a Mockingbird", "Harper Lee", "1960-07-11"),
					new Book(3L, "1984", "GeorgeOrwell", "1949-06-08"),
					new Book(5L, "1984", "GeorgeOrwell", "1949-06-08"),
